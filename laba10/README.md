...
**Выполнил**: Студент группы 241-672 Мурашкина В.В.

## 1. Сайты и их описание
1. [Promo Interactive](https://promo.ru/) - Digital-агентство, маркетинговое агентство.
*Предметная область*: Маркетинг, digital-маркетинг, разработка сайтов, SMM, SEO, контекстная реклама, брендинг. Компания специализируется на создании комплексных маркетинговых стратегий и их реализации.

1. [Цифровой элемент](https://d-element.ru/) - Digital-агентство, IT-компания.
*Предметная область*: Разработка мобильных приложений, веб-разработка, создание сайтов, разработка CRM-систем, интернет-маркетинг, цифровые решения для бизнеса. Ориентированы на разработку и внедрение IT-решений для бизнеса.
1. [Факт](https://fact.digital/) - Digital-агентство, IT-компания. *Предметная область*: Веб-разработка, дизайн, мобильные приложения, создание сайтов, digital-маркетинг, брендинг, автоматизация бизнес-процессов. Занимаются созданием сайтов и цифровых продуктов, а также маркетинговой поддержкой.
1. [BrandStudio](https://bstd.ru/) - IT-компания, интегратор. *Предметная область*: Разработка программного обеспечения, внедрение информационных систем, IT-консалтинг, автоматизация бизнес-процессов, интеграция CRM и ERP-систем. Специализируется на сложных интеграционных проектах и программных решениях для бизнеса.
1. [Синий муравей](https://blue-ant.ru/) - Digital-агентство, маркетинговое агентство. *Предметная область*: Digital-маркетинг, создание сайтов, SMM, SEO, контекстная реклама, таргетированная реклама, email-маркетинг. Ориентированы на продвижение бизнеса в интернете.
1. [КИРПИЧ](https://kirpichagency.com/) - Креативное агентство, маркетинговое агентство. *Предметная область*: Брендинг, креатив, дизайн, реклама, digital-маркетинг, разработка сайтов. Агентство специализируется на создании креативных концепций и их реализации.
1. [ДАЛЕЕ](https://dalee.ru/) - Digital-агентство. *Предметная область*: Разработка и поддержка сайтов, интернет-маркетинг, SEO-продвижение, контекстная реклама, SMM. Компания ориентируется на создание и продвижение сайтов в интернете.
1. [RuNetSoft](https://softcreators.ru/) - IT-компания, разработчик ПО. *Предметная область*: Разработка программного обеспечения, мобильных приложений, веб-разработка, интеграция IT-систем, IT-консалтинг, создание интернет-магазинов. Специализируется на разработке программных решений для бизнеса.
1. [Верно](https://verno.digital/) - Digital-агентство, маркетинговое агентство. *Предметная область*: Digital-маркетинг, веб-разработка, SMM, SEO, контекстная реклама, таргетированная реклама, дизайн, брендинг. Компания предлагает комплексные digital-услуги для бизнеса.
1. [CHIPSA](https://chipsa.ru/) - IT-компания, разработчик ПО. *Предметная область*: Разработка программного обеспечения, мобильных приложений, веб-разработка, создание сайтов, внедрение IT-решений для бизнеса. Разрабатывают сложные программные решения и цифровые продукты.

### 1.1 Описание свойств/комплексов CSS
|№|Синтаксис (правила), значения, прочая информация|Назначение|Где встретилось (ссылка на сайт)|
|-|------------------------------------------------|----------|--------------------------------|
|1|transition: [transition-property, transition-duration, transition-timing-function, transition-delay]|Позволяет делать плавные переходы между двумя значениями какого-либо CSS свойства.|https://promo.ru/portfolio/|
|2|overflow-x: [visible, hidden, scroll, auto, clip]|Определяет, как будет отображаться содержимое элемента, если оно не помещается слева/справа в область вывода данного элемента.|https://d-element.ru/|
|3|unicode-bidi: [normal, embed, bidi-override, isolate, isolate-override, plaintext]|Это свойство вместе со свойством direction определяет, как должен располагаться текст используемого языка.|https://fact.digital/portfolio-web-studii/korporativnyy-sayt/|
|4|cursor: [auto, crosshair, default, help, move, n-resize, ne-resize, e-resize, se-resize, s-resize, sw-resize, w-resize, text, pointer, progress, wait, URL]|Определяет вид курсора при наведении мышки на элемент. Вид курсора зависит от операционной системы и установленных параметров.|https://bstd.ru/|
|5|swiper-theme-color|Это кастомная переменная, она может определять основной цвет, используемый для стилизации различных элементов слайдера.|https://blue-ant.ru/services|
|6|visibility: [visible, hidden, collapse]|Определяет видимость элемента.|https://kirpichagency.com/|
|7|opacity|Устанавливает непрозрачность (степень, в которой содержимое скрыто за элементом, противоположность прозрачности) элемента.|https://dalee.ru/services/web-development|
|8|overscroll-behavior: [auto, contain, none]|Сокращение для свойств overscroll-behavior-x и overscroll-behavior-y, которые позволяют управлять поведением прокрутки при достижении границы области прокрутки.|https://verno.digital/|
|9|user-select: [none, auto, text, all, contain]|Определяет, может ли пользователь выделить текст. Оно не влияет на контент за исключением текстовых блоков.|https://verno.digital/cases|
...
- `<div class="modal modal--form"`: Модальное окно с формой.
...
17. **JavaScript (для управления каруселью)**
  - Добавьте JavaScript-код для управления каруселью в конце тега `<body>` или в отдельном js файле.
    ...
    <script>
        ...
        if (carousel && slider && slides.length) {
            let currentIndex = 0;
